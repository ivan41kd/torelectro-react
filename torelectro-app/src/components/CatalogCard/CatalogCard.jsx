...
export const CatalogCard = ({ product, items, index }) => {
  ...
  <div className='catalog__card swiper-slide'>
   <div className='catalog__card-wrapper'>
    ...
    <div className='catalog__card-info'>
     ...
     <Dialog.Root>
      <Dialog.Trigger className='catalog__card-button'>
       Посмотреть
      </Dialog.Trigger>
      <Dialog.Portal>
       <Dialog.Overlay className='product'>
        <Dialog.Content className='product__wrapper'>
